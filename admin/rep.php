...
if(isset($_POST['submit'])){
	...
	$sql="select * from reviews inner join products on reviews.prod_id=products.prod_id where reply like '%$str%' or review like '%$str%'";
	...
	if(mysqli_num_rows($res)>0){
		echo "<br/>";
			...
			<tr class="col">
			<td class="col"><?php echo "PRODUCT_ID";?></td>
			<td class="col"><?php echo "REPLY";?></td>
			<td class="col"><?php echo "REVIEW";?></td>
			</tr>
			<?php
		...
		{?>
			...
			<td class="col"><?php echo $row['reply'];?></td>
			<td class="col"><?php echo $row['review'];?></td>
			</td>
			</tr>
