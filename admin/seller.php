...
if(isset($_POST['submit'])){
	...
	$sql="select * from seller where email like '%$str%' or username like '%$str%' or seller_id like '%$str%' or bname like '%$str%'";
	...
	if(mysqli_num_rows($res)>0){
		echo "<br/>";
			...
			<td class="col"><?php echo "Userame";?></td>
			<td class="col"><?php echo "email";?></td>
			<td class="col"><?php echo "ID";?></td>
			<td class="col"><?php echo "CONTACT INFO";?></td>
            <td class="col"><?php echo "BUSINESS NAME";?></td>
			</tr>
			<?php
		...
		{?>
			...
			<td class="col"><?php echo $row['email'];?></td>
			<td class="col"><?php echo $row['seller_id'];?></td>
            <td class="col"><?php echo $row['contact_no'];?></td>
            <td class="col"><?php echo $row['Bname'];?></td>
			</tr>
...
{
	return confirm('are you sure you want to delete this record, DELETING RECORD MAY DELETE SAID PERSONS PRODUCTS AS WELL');
}
function checkedit()
{
